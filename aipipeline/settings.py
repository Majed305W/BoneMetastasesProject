"""
Django settings for aipipeline project.
...
SECRET_KEY = 'django-insecure-jai=pn30*wizs=vg+m25dl@h8l+st=#%7yoybavv#1cvf+jps#'
...
WSGI_APPLICATION = 'aipipeline.wsgi.application'
